  ...
  <main>
    <?php if (have_posts()): while (have_posts()): the_post(); ?>
      <article>
        ...
        <li>私がこのブログを始めたきっかけは、インスタグラムでした。
        個人学習の忘備録をインスタ投稿しており、インスタで伝えきれなかった内容をブログで補っていました。</li>
        <li>ブログを書いていくうちに、歴史の面白さと奥深さに魅せられ、「もっと深く知りたい！」という探求心に駆られるようになりました。そこで、範囲をフランス史から欧州史に広げ、個人的に気になる歴史上の出来事や人物、そして時代とともに変貌する美術・建築に焦点を当てて書くようになりました。</li>
        <li>歴史はドラマのように面白い！この面白さをブログを通して伝えたい！そんな気持ちで記事を書いております。
        歴史ファンみなさまの心に刺されば幸いです。</li>
        </ul>
